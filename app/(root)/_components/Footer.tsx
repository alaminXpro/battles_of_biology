      ...
      <div className="container mb-24 md:mb-0">
        ...
        <div className="pb-5 text-center">
          <p className="text-xs font-normal text-gray-600 md:text-sm">
            <a href="https://www.linkedin.com/in/alaminxpro/" className="animate-text bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent font-black">AlaminXpro</a>. All rights reserved.
          </p>
        </div>
        <button
        ...
        >
          ...
          <span className="hidden md:inline-block"><a href="https://www.linkedin.com/in/alaminxpro/">সরাসরি কথা বলুন</a></span>
        </button>
      </div>
    </div>
  );
